...
public class StrangeFlameAnimationEffect extends AbstractGameEffect {
  ...
  public StrangeFlameAnimationEffect(Hitbox hb) {
    this.nodeHb = hb;
    ...
    this.offsetY = MathUtils.random(-3.0F, 6.0F) * Settings.scale;
    alternator = !alternator;
    this.flipped = alternator;
    if (!alternator)
      this.offsetX = -this.offsetX; 
    this.color = new Color(0.34F, 0.34F, 0.34F, 0.75F);
